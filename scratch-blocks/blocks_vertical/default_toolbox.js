...
Blockly.Blocks.defaultToolbox = '<xml id="toolbox-categories" style="display: none">'+
    '<category name="'+Blockly.Msg.Motion+'" colour="#4C97FF" secondaryColour="#3373CC">'+
    ...
    '</category>'+
    '<category name="'+Blockly.Msg.Looks+'" colour="#9966FF" secondaryColour="#774DCB">'+
    ...
    '</category>'+
    '<category name="'+Blockly.Msg.SOUND+'" colour="#D65CD6" secondaryColour="#BD42BD">'+
    ...
    '</category>'+
    '<category name="'+Blockly.Msg.PEN+'" colour="#00B295" secondaryColour="#0B8E69">'+
    ...
    '</block>'+
    '</category>'+
    '<category name="'+Blockly.Msg.DATA+'" colour="#FF8C1A" secondaryColour="#DB6E00" custom="VARIABLE">'+
    '</category>'+
    '<category name="'+Blockly.Msg.LIST+'" colour="#FF8C1A" secondaryColour="#DB6E00">'+
    ...
    '</category>'+
    '<category name="'+Blockly.Msg.EVENTS+'" colour="#FFD500" secondaryColour="#CC9900">'+
    ...
    '</block>'+
    '</category>'+
    '<category name="'+Blockly.Msg.CONTROL+'" colour="#FFAB19" secondaryColour="#CF8B17">'+
    ...
    '</category>'+
    '<category name="'+Blockly.Msg.SENSING+'" colour="#4CBFE6" secondaryColour="#2E8EB8">'+
    ...
    '</category>'+
    '<category name="'+Blockly.Msg.OPERATORS+'" colour="#40BF4A" secondaryColour="#389438">'+
